...
import { ArrowLeft, Printer as Print } from "lucide-react"
      ...
      <div className="container py-8 print:py-0">
        <div className="print:hidden mb-6 flex items-center justify-between">
          ...
          <Button onClick={handlePrint} className="inline-flex items-center gap-2">
            <Print className="h-4 w-4" /> Print / Save as PDF
          </Button>
        </div>
        ...
        <div className="max-w-4xl mx-auto bg-white p-8 print:p-0 print:shadow-none shadow-lg">
          ...
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">KHUSHI ARORA</h1>
            <div className="text-gray-600 space-y-1">
              <p>Newcastle upon Tyne, UK</p>
              <p>+44 7867 476576 | khushii.aroraa11@gmail.com | linkedin.com/in/khushiarora1/</p>
            </div>
          </div>

          {/* Summary */}
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 border-b-2 border-gray-300 pb-2 mb-4">SUMMARY</h2>
          ...
          {/* Work Experience */}
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 border-b-2 border-gray-300 pb-2 mb-4">WORK EXPERIENCE</h2>
          ...
          {/* Skills & Languages */}
          <section className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 border-b-2 border-gray-300 pb-2 mb-4">SKILLS & LANGUAGES</h2>
            <div className="space-y-2">
              <p className="text-gray-700">
                <span className="font-semibold">Skills:</span> Social Media Management & Strategy, Content Creation &
                Video Editing (Canva, Figma, Adobe Creative Suite & CapCut), Copywriting, Social Media Analytics & KPI
              ...
              <p className="text-gray-700">
                <span className="font-semibold">Languages:</span> English (Fluent) & Hindi (Native).
              </p>
            </div>
          </section>
        </div>
