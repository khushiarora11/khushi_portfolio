...
export default function CarabaoCupVideoPage() {
  const instagramLink = "https://www.instagram.com/reel/DHP1O9iomRt/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA=="
      ...
      <div className="container py-20">
        <div className="max-w-4xl mx-auto">
          <div className="mb-6 flex items-center">
            ...
            <h1 className="text-3xl font-bold">Carabao Cup Score Predictions</h1>
          </div>
          ...
          <div className="max-w-[500px] mx-auto">
            ...
            >
              <Image
                src="/images/carabao-cup-thumbnail.png"
                alt="Carabao Cup Score Predictions"
                fill
          ...
          <div className="mt-8 bg-white dark:bg-gray-900 p-6 rounded-lg shadow-md">
            ...
            <p className="mb-4">
              Planned, executed, and delivered a Carabao Cup score predictions video from concept to completion,
              engaging football fans and promoting university sports culture.
            </p>
            <div className="bg-fuchsia-50 dark:bg-fuchsia-900/20 p-3 rounded-md">
              ...
              <p>
                Achieved over 6K views—20% higher than the average engagement, increasing visibility and student
